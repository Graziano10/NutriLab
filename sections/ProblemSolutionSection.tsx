...
import { CheckCircleIcon, ClipboardIcon, LeafIcon } from '@/components/SiteIcons';

const painPointIcons = [LeafIcon, ClipboardIcon, CheckCircleIcon];
      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[0.88fr_1.12fr] lg:items-start lg:px-8">
        ...
        <div className="grid gap-6">
          {painPoints.map((point, index) => {
            const Icon = painPointIcons[index] ?? CheckCircleIcon;
            ...
            return (
              ...
              >
                <div className="flex items-start gap-4">
                  <span className="inline-flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-br from-brand-300 to-brand-500 text-brand-900">
