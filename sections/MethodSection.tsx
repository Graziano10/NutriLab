...
import { CalendarIcon, ChatIcon, ClipboardIcon, CheckCircleIcon } from '@/components/SiteIcons';
import { methodSteps } from '@/lib/site-data';

const methodStepIcons = [ClipboardIcon, CalendarIcon, ChatIcon, CheckCircleIcon];
    ...
    <section id="method" className="py-20 sm:py-24">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <SectionHeading
          ...
          theme="dark"
        />
        <div className="relative mt-14 grid gap-6 md:mx-auto md:max-w-5xl md:grid-cols-2 lg:max-w-none lg:grid-cols-4">
          ...
          {methodSteps.map((item, index) => {
            const StepIcon = methodStepIcons[index] ?? ClipboardIcon;
            ...
            return (
              ...
              >
                <div className="absolute right-5 top-5 inline-flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-white/10 text-brand-200">
